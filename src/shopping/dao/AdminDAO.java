...
public class AdminDAO {
	...
	public Admin findById(java.lang.String id) {
		...
		try {
			Admin instance = (Admin) getCurrentSession().get("shopping.model.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("shopping.model.Admin")
