...
public class ProductDAO  {
	...
	public static final String PRODUCTCOL = "productcol";
    ...
    public List findByExample(Product instance) {
        ...
        try {
            List results = getCurrentSession().createCriteria("shopping.model.Product") .add(Example.create(instance)).list();
	...
	public List findByProductcol(Object productcol
	) {
		return findByProperty(PRODUCTCOL, productcol
		);
	}
