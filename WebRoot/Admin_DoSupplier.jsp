...
<body>
			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane active" id="user" >
					<div class="check-div form-inline">
						<div class="col-xs-3">
							<button class="btn btn-yellow btn-xs" data-toggle="modal"
								data-target="#addUser" onclick="changein()">添加商铺账号</button>
						</div>
						<div class="col-xs-4">
					...
					<ul class="pagination">
						...
						<li><a href="AgentJump_ToCheakSupplier.action?pagetype='可用'&page=${(cheak_sup_page-1)>0?cheak_sup_page-1:1}">
						<i class="glyphicon glyphicon-menu-left"></i>
						</a></li>
						<li><a href="AgentJump_ToCheakSupplier.action?pagetype='可用'&page=${(cheak_sup_page+1)<cheak_sup_page_sum?cheak_sup_page+1:cheak_sup_page_sum}"><i class="glyphicon glyphicon-menu-right"></i></a></li>
					</ul>
					</footer>
	...
	<script>
		...
		function jumppage(){
        	...
        	location.href="AgentJump_ToCheakSupplier.action?pagetype='可用'&page="+page; */
		}
